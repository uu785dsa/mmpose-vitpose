...
from ..utils import (MultiheadAttention, SwiGLUFFNFused, build_norm_layer,
                     resize_pos_embed, to_2tuple,MultiHeadDifferentialAttention)
...
class DiffVisionTransformer(BaseBackbone):
    """Vision Transformer.
    ...
    def __init__(self,
                 ...
                 pre_norm=False,
                 init_cfg=None):
        super(DiffVisionTransformer, self).__init__(init_cfg)
    ...
    def init_weights(self):
        super(DiffVisionTransformer, self).init_weights()
